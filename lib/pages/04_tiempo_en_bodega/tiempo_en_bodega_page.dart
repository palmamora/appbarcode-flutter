...
class TiempoEnBodegaPage extends StatefulWidget {
  @override
  _TiempoEnBodegaPageState createState() => _TiempoEnBodegaPageState();
}

class _TiempoEnBodegaPageState extends State<TiempoEnBodegaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Tiempo en Bodega')),
      body: Column(
